        ...
        <div class="container">
        	<div class="page-container row">
                ...
                <div class="table-responsive">
                  <?php echo anchor(base_url('campaign/subcategory'), '<i class="bx bx-plus"></i> New', 'class="btn btn-secondary btn-sm"'); ?>
                                  ...
                                  <td><?php echo $row->category_id;?></td>
                               	<td>
	                             		<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
	                             			<?php echo anchor(base_url('campaign/edit_subcategory/'.$row->subcategory_id), '<i class="btn bx bx-edit-alt"></i>', 'class="btn btn-secondary btn-sm"'); ?>
