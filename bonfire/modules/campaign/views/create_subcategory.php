     ...
     <div class="card col-sm-6">
       <div class="card-body">
          ...
          $attributes = array('class' => 'form-horizontal', 'method' => 'post', 'id' => 'myform', 'accept-charset'=>'utf-8');
                    echo form_open_multipart('campaign/subcategory', $attributes);
          ?> 
                     <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                             <?php
                              echo form_dropdown('category_name',$category_item,set_value('category'),'','class="form-control"'); echo '<div class="error">'.form_error('category').'</div>';
                              ?>   
                         </div>
                      </div>
                       <div class="form-group row">
