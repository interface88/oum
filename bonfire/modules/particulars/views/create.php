     ...
     <div class="card col-sm-12">
       <div class="card-body">
          ...
          $attributes = array('class' => 'form-horizontal', 'method' => 'post', 'id' => 'myform', 'accept-charset'=>'utf-8');
                    echo form_open_multipart('particulars/create', $attributes);
          ?> 
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                             <?php echo form_input(array('class' =>'form-control', 'id'=>'percentage', 'name'=>'percentage', 'type'=>'text', 'value'=>set_value('percentage'),)); echo '<div class="error">'.form_error('percentage').'</div>';?>    
                         </div>
                      </div>
